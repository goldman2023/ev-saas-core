...
class BlogsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        if (\DB::table('blog_posts')->count() == 0) {
            ...
            // TODO: Guess we don't really need it, cuz owner will add blog post if he/she wants??
            ...
            //             'slug' => 'hellow-world',
            //             'short_description' => 'This is your first blog post. You can edit or delete it.',
