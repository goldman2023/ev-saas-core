...
class CategoriesSelector extends Component
{
     ...
     * @return void
     */
    public function __construct($items = [], $name = '', $appendToName = false, $label = '',  $multiple = false, $placeholder = '', $required = false,  $class = '', $icon = null, $merge = false, $errorBagName = null)
    {
        $this->items = $items;
        $this->label = $label;
        $this->name = $name;
