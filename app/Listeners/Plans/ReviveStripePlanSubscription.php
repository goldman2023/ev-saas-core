    ...
    public function handle(PlanSubscriptionRevive $event)
    {
        ...
        if(Payments::stripe()->enabled) {
            ...
            if(!get_tenant_setting('multiplan_purchase')) {
                ...
                /** 
                 * 
                 * There are to cases of revival:
                 * 1. Revival after subscription end_date is passed and status is 'inactive'
                 * 2. Revival before subscription end_date is passed and status is 'active_until_end'
                 * 
                 */

                // $stripe->subscriptions->create([
                //     'customer' => 'cus_J4tVh6c3hIPRaT',
                //     'items' => [
                //       ['price' => 'price_1KrTGTASOFrdz0QBA9XLhG4Z'],
                //     ],
                //   ]);
