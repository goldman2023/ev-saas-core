...
//        CoreComponentRepository::instantiateShopRepository();
    ...
    public function payment_method_update(Request $request)
    {
        ...
        $business_settings = get_setting($request->payment_method.'_sandbox')->first();
    ...
    public function google_analytics_update(Request $request)
    {
        ...
        $business_settings = get_setting('google_analytics')->first();
    ...
    public function google_recaptcha_update(Request $request)
    {
        ...
        $business_settings = get_setting('google_recaptcha')->first();
    ...
    public function facebook_chat_update(Request $request)
    {
        ...
        $business_settings = get_setting('facebook_chat')->first();
    ...
    public function facebook_comment_update(Request $request)
    {
        ...
        $business_settings = get_setting('facebook_comment')->first();
    ...
    public function facebook_pixel_update(Request $request)
    {
        ...
        $business_settings = get_setting('facebook_pixel')->first();
    ...
    public function seller_verification_form_update(Request $request)
    {
        ...
        $business_settings = get_setting('verification_form')->first();
    ...
    public function update(Request $request)
    {
        foreach ($request->types as $key => $type) {
            ...
            if($type == 'timezone'){
                ...
                $business_settings = get_setting($type)->first();
    ...
    public function updateActivationSettings(Request $request)
    {
        ...
        $business_settings = get_setting($request->type)->first();
        if($business_settings!=null){
    ...
    {
        $business_settings = get_setting('vendor_commission')->first();
