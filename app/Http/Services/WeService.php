            ...
            [
                ...
                'items' => [
                    [
                        ...
                        'is_active' => areActiveRoutes(['orders.index', 'order.create', 'order.details']),
                        'user_types' => User::$non_customer_user_types,
                        'permissions' => ['browse_orders'],
                        'badge' => [
                            'class' => 'badge-danger',
                    ...
                    [
                        ...
                        'is_active' => areActiveRoutes(['products.index', 'attributes.index', 'product.details', 'product.create']),
                        'user_types' => User::$non_customer_user_types,
                        ...
                        'children' => [
                            [
                                ...
                                'route' => route('products.index'),
                                'route_name' => 'products.index',
                                'is_active' => areActiveRoutes(['products.index',  'product.details', 'product.create']),
                                'user_types' => User::$non_customer_user_types,
                    ...
                    [
                        ...
                        'is_active' => areActiveRoutes(['categories.index', 'category.edit', 'category.create']),
