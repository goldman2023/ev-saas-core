    ...
    public function filters(): array
    {
        return [
            'status' => Filter::make('Status')
                ->select([
                    '' => translate('All'),
                    BlogPost::STATUS_PUBLISHED => translate('Published'),
                    BlogPost::STATUS_DRAFT => translate('Draft'),
                    BlogPost::STATUS_PENDING => translate('Pending'),
                    BlogPost::STATUS_PRIVATE => translate('Private'),
                ]),
