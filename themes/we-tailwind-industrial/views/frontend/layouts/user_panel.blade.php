...
<div>
    ...
    <div
        class="hidden we-dashboard-sidebar-background lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 lg:border-r lg:border-gray-200 lg:pt-5 lg:pb-4 lg:bg-black">
        ...
        <div class="mt-6 h-0 flex-1 flex flex-col overflow-y-auto">
            ...
            <div class="px-3 relative inline-block text-left">
                <div>
                    <button type="button"
                        class="group w-full bg-black rounded-md px-3.5 py-2 text-sm text-left font-medium text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-purple-500"
                        id="options-menu-button" aria-expanded="false" aria-haspopup="true">
                        <span class="flex w-full justify-between items-center">
                            <span class="flex min-w-0 items-center justify-between space-x-3">
                                <img class="w-10 h-10 bg-gray-300 rounded-full flex-shrink-0"
                                    src="{{ Auth::user()->getUpload('avatar') ?: 'https://htmlstream.com/front/assets/img/160x160/img1.jpg' }}"
                                    alt="">
                                <span class="flex-1 flex flex-col min-w-0">
                                    <span class="text-gray-100 text-sm font-medium truncate">{{ Auth::user()->name
                                        }}</span>
                                    <span class="text-gray-300 text-sm truncate">{{ Auth::user()->email }}</span>
                                </span>
                            </span>
