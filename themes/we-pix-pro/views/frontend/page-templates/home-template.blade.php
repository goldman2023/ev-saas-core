                ...
                <div class="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-7 lg:text-left">
                    <div we-slot="" name="title_slot" we-title="Hero Title" class="w-full">
                        <h1 we-name="hero_title" we-title="Title"
                            class="block text-center lg:text-left font-semibold lg:font-black leading-none text-gray-900 text-28 sm:text-36 lg:text-[48px] xl:text-[60px] lg:pr-[3rem]">
...
{{-- FEATURES --}}
<div
    class="relative bg-white py-16 sm:py-24 lg:py-32 lg:pt-[80px] lg:pb-[80px] sm:pt-[50px] sm:pb-[50px] pt-[40px] pb-[40px] bg-[#fff]">
    <div class="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
        <div we-slot="" name="tagline_slot" we-title="Tagline" class="w-full">
            <h3 we-name="tagline" we-title="Title" class="text-18 font-semibold tracking-wider text-primary uppercase">
                Features
            </h3>
        </div>
        ...
        <div we-slot="" name="title_slot" we-title="Title" class="w-full">
            <h2 we-name="title" we-title="Title"
                class="mt-2 text-3xl font-extrabold tracking-tight text-gray-900 sm:text-5xl">
                Every tool needed under one roof
            </h2>
        </div>

        <div we-slot="" name="subtitle_slot" we-title="Subtitle" class="w-full">
            <p we-name="subtitle" we-title="Subtitle" class="mx-auto mt-5 max-w-prose text-xl text-gray-500">
                ...
                <div class="pt-6">
                    <div class="flow-root bg-white rounded-lg border border-gray-200 hover:shadow-lg px-6 py-5 h-full">
                        <div class="-mt-6 h-full">
                            ...
                            <div class="w-full">
                                <h4 class="mt-8 text-20 font-medium tracking-tight text-gray-900 max-w-[250px] mx-auto">
...
{{-- TESTIMONIALS --}}
<section class="bg-[#F5F5F5] py-[40px] sm:py-[50px] md:py-[80px] bg-white">
    <div class="container !max-w-[90%]">
        <div class=" text-center">
            ...
            <h2 class="text-28 md:text-[48px] font-black leading-[28px] md:leading-[48px] text-gray-900 mb-3">We put our
                clients first</h2>
            <p class="text-18 text-gray-600">All of our tools and technologies are designed, modiefied &amp; <br
                    class="d-inline"> updated keeping your needs in mind</p>
        </div>
        <div class="client-content pt-10 grid grid-cols-2 gap-10">
            <div class="col-span-2 md:col-span-1">
                <div class="px-8 py-5 bg-white shadow-2xl rounded-sm hover:shadow-4xl transition-all duration-300"
                    ...
                    <div class="flex gap-4 items-center justify-center pb-4">
        ...
        <div class="flex items-center justify-center mt-8 gap-3">
            <a href="/users/login" class="mb-0 text-lg2 font-bold text-primary-dark underline ">Start Free 1 Month TrialNow</a>
        </div>
    </div>
</section>
