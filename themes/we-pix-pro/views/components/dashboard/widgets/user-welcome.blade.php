    ...
    <div class="px-4 sm:px-6 lg:mx-auto lg:px-8">
        <div class="py-6 lg:flex lg:flex-wrap lg:items-center lg:justify-between lg:border-t lg:border-gray-200">
                    ...
                    <div>
                        <div class="flex items-center ">
                            ...
                            <h1 class="ml-3 text-2xl font-bold leading-7 text-gray-900 sm:leading-9 sm:truncate">
                                ...
                                {{ translate('Hello') }}, {{ Auth::user()->name }}
                            </h1>
                        </div>
                        <dl class="mt-6 flex flex-col sm:ml-4 sm:mt-1 sm:flex-row sm:flex-wrap">
                            ...
                            <dd
                                ...
                                {{ auth()->user()->user_type }} {{ translate('account') }}
                            </dd>
                        </dl>
                    </div>
                </div>
            ...
            <div class="mt-6 flex space-x-3 lg:mt-0 lg:ml-4">
                ...
                @endif
                <a target="_blank" type="button" href=" {{ route('my.plans.management') }}" class="btn-primary">
