        ...
        <div class="container header-hide-content pt-2">
            <div class="d-flex align-items-center ev-top-bar">
                ...
                <ul class="list-inline ml-2 mb-0">
                    ...
                    <li class="list-inline-item">
                        <div class="hs-unfold">
                            <a href="{{ route('user.logout') }}" data-test="we-logout-header"
                    ...
                    <li class="list-inline-item">
                        <a href="javascript:;" x-data="" data-test="we-login-header"
...
<div class="alert alert-success alert-block mb-0" data-test="we-user-feedback-inline-notification"
