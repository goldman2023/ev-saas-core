@if ($this->showBulkActionsDropdown)
    <div class="mb-3 mb-md-0">
        <div class="dropdown d-block d-md-inline">
            <button class="btn btn-sm btn-secondary d-block w-100 d-md-inline" type="button" id="bulkActions" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                @lang('Bulk Actions')
            </button>
