...
>
    <div class="w-full flex justify-between items-center flex-wrap">
        <h3 class="flex items-center gap-x-2 ">
            <span class="text-lg leading-6 font-400 text-gray-900">{{ translate('Cycle status') }}: </span>
            <span class="text-md leading-6 font-medium text-gray-900 border px-2 py-1 rounded-md">{{ $current_cycle_status_label }}</span>
        </h3>
        ...
        @if(!empty($order->id))
            ...
            <div class="w-full flex gap-x-1 text-14 items-center flex-[1_0_100%] mt-4 justify-between flex-wrap">
