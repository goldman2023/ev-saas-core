...
<div class="mb-8 w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
...
<div class="bg-white rounded shadow">
    <h2 class="pt-4 text-center font-bold text-xl">
        {{ get_site_name() }}
    </h2>
    <div class="grid mx-auto max-w-7xl divide-y divide-gray-200 lg:justify-center lg:divide-y-0 lg:divide-y lg:py-8">
      <div class="py-8  mb-3 lg:flex-none lg:py-0">
        <div class="mx-auto  text-center max-w-xs items-center px-4 lg:max-w-none lg:px-8">
          <!-- Heroicon name: outline/calendar -->
          <svg class="mx-auto h-8 w-8 mb-3 flex-shrink-0 text-indigo-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
      ...
      <div class="py-8 mb-3 text-center">
        <div class="mx-auto max-w-xs items-center px-4 lg:max-w-none lg:px-8">
          ...
          <svg class="h-8 w-8 mb-3 mx-auto flex-shrink-0 text-indigo-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
      ...
      <div class="py-8 text-center lg:flex-none">
        <div class="mx-auto max-w-xs items-center px-4 lg:max-w-none lg:px-8">
          ...
          <svg class="h-8 w-8 mx-auto mb-3 flex-shrink-0 text-indigo-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
