                ...
                <div class="flex flex-wrap items-center">
                    ...
                    <div class="w-full lg:w-1/2">
                        <div
                            ...
                            {{-- TODO: Initial version of <x-system.social-logins-buttons>
                                Component to handle all the settings and options for social logins
                                --}}
                                @if(get_setting('enable_social_login'))
