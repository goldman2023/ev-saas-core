    ...
    <div class="max-w-6xl mx-auto py-12 px-4 sm:px-5 lg:py-16 lg:px-8">
        <div class="lg:grid lg:grid-cols-5 lg:gap-8">
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-8 col-span-1 lg:col-span-3">
                <div>
                    <x-tenant.system.image alt="{{ get_site_name() }} logo" class="h-30 w-auto sm:h-30"
                        :image="get_site_logo()">
                    </x-tenant.system.image>
                    {{-- <h3 class="text-sm font-semibold text-white tracking-wider uppercase">{{ translate('Product')
                        }}</h3> --}}
                    <ul role="list" class="mt-4 space-y-4">
                        {{-- TODO: add a dynamic menu here --}}
                    </ul>
                </div>
            ...
            <div class="col-span-1 lg:col-span-2 xl:mt-0">
        ...
        <div class="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p class="mt-8 text-base text-gray-400 md:mt-0 md:order-1">&copy; {{ date('Y') }} - {{ get_site_name() }}
            </p>
        </div>
    </div>
</footer>
