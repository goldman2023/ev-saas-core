                        ...
                        <div class="grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:col-span-3 lg:gap-x-8">
                            @if($content == 'product' || $content == null)
                                @foreach ($products as $key => $product)
                                    <x-tenant.product.cards.image-overlay-and-button
                                        :product="$product"></x-tenant.product.cards.image-overlay-and-button>
                                @endforeach
                            @endif
                            {{-- TODO: Check if pagination wotks propertly --}}
