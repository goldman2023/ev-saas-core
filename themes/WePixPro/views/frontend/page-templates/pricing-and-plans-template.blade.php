...
<section class="relative  lg:pt-[80px]  lg:pb-[80px]  sm:pt-[60px]  sm:pb-[60px]  pt-[40px]  pb-[40px]   bg-[#fff]   "
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:flex-col sm:align-center mb-[40px]">
            <x-dashboard.widgets.customer.pricing-table :isTrial="false" :hideTitle="false" :subscribed="false"
                :plans="$models">
                            ...
                            <td class="px-5 py-5 border-1 bg-white ">
                                <div class="flex items-center justify-center">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <path d="M5 13L9 17L19 7" stroke="#8BC53F" stroke-width="2"
                        ...
                        <tr>
                            ...
                            <td class="px-5 py-5 border-1 bg-white ">
                                <div class="flex items-center justify-center">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M6 18L18 6M6 6L18 18" stroke="#FF4E3E" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
