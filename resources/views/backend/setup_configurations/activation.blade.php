    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body text-center">
                ...
                <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    {{ translate('After activate this option Seller commision will be disabled and You need to set commission on each category otherwise Admin will not get any commision')}}. <a href="{{ route('admin.categories.index') }}">{{ translate('Set Commisssion Now')}}</a>
                </div>
            </div>
        </div>
    </div>
...
<h4 class="text-center text-muted mt-4">{{translate('EIM Modules')}}</h4>

<div class="row">
    <div class="col-lg-4">
        <div class="card">
            <div class="card-header">
                <h3 class="mb-0 h6 text-center">{{translate('B2B Jobs')}}</h3>
            </div>
            <div class="card-body text-center">
                <label class="aiz-switch aiz-switch-success mb-0">
                    @php
                    ...
                    @endphp
                    <input type="checkbox" onchange="updateSettings(this, 'jobs_module')" <?php if($jobs_activated) echo "checked";?>>
                    <span class="slider round"></span>
                </label>
                <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    {{ translate('Enable this to enable jobs functionality') }}.
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-4">
        <div class="card">
            <div class="card-header">
                <h3 class="mb-0 h6 text-center">{{translate('B2B Events')}}</h3>
            </div>
            <div class="card-body text-center">
                <label class="aiz-switch aiz-switch-success mb-0">
                    @php
                    ...
                    @endphp
                    <input type="checkbox" onchange="updateSettings(this, 'events_module')" <?php if($events_activated) echo "checked";?>>
                    <span class="slider round"></span>
                </label>
                <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
                    {{ translate('Enable this to enable events functionality') }}.
                </div>
            </div>
        </div>
    </div>
