            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    <ul class="nav nav-tabs nav-fill border-light">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-reset @if ($language->code == $lang) active @else bg-soft-dark border-light border-left-0 @endif py-3" href="{{ route('admin.products.edit', ['id'=>$product->id, 'lang'=> $language->code] ) }}">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control aiz-selectpicker" data-live-search="true" data-selected-text-format="count" name="colors[]" id="colors" multiple @if(count($product->colors) <= 0) disabled @endif>
                                    @foreach (\App\Models\Color::orderBy('name', 'asc')->get() as $key => $color)
                                    <option
                                        value="{{ $color->code }}"
                                        data-content="<span><span class='size-15px d-inline-block mr-2 rounded border' style='background:{{ $color->code }}'></span><span>{{ $color->name }}</span></span>"
                                        <?php if (in_array($color->code, $product->colors)) echo 'selected' ?>>
                                    </option>
                                    @endforeach
                                </select>
                            </div>
...
<script type="text/javascript">
	...
	$('#choice_attributes').on('change', function() {
		...
		var str = @php echo json_encode($product->attributes); @endphp;
