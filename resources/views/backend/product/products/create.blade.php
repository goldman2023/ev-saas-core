                    ...
                    <div class="card-body">
                        ...
                        @else
                            <p>
                                ...
                                <a href="{{route('activation.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['admin.shipping_configuration.index','admin.shipping_configuration.edit','admin.shipping_configuration.update'])}}">
