    ...
    <div class="card-body">
        <table class="table aiz-table mb-0">
			...
			<td>{{ $category->level }}</td>
                        ...
                        <td class="text-right">
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('admin.categories.edit', ['id'=>$category->id, 'lang'=>config('app.locale')] )}}" title="{{ translate('Edit') }}">
                                <i class="las la-edit"></i>
                            </a>
                            <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('admin.categories.destroy', ['id'=>$category->id])}}" title="{{ translate('Delete') }}">
