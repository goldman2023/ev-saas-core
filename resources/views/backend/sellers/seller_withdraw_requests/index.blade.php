                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"  onclick="show_message_modal('{{ $seller_withdraw_request->id }}');" title="{{ translate('Message View') }}">
    		                            ...
    		                            <a href="{{route('admin.sellers.payment_history', $seller_withdraw_request->user_id)}}" class="btn btn-soft-primary btn-icon btn-circle btn-sm"  title="{{ translate('Payment History') }}">
