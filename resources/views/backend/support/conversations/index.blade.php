        ...
        <table class="table aiz-table mb-0" cellspacing="0" width="100%">
            ...
            <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <a class="btn btn-soft-primary btn-icon btn-circle btn-sm" href="{{route('admin.conversations.show', $conversation->id)}}" title="{{ translate('View') }}">
                                <i class="las la-eye"></i>
                            </a>
                            <a href="#" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" data-href="{{route('conversations.destroy', $conversation->id)}}" title="{{ translate('Delete') }}">
