          ...
          <div class="relative inline-block">
            ...
            <div class="origin-top-right absolute right-0 mt-2 w-40 rounded-md shadow-2xl bg-white ring-1 ring-black ring-opacity-5 focus:outline-none"
              ...
              <div class="py-1" role="none">
                <a href="#" @click="active = 'price'" :class="{'font-medium text-gray-900': active == 'price', 'text-gray-500': active != 'price'}" class="block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0"> {{ translate('By Price') }} </a>
                <a href="#" @click="active = 'discount'" :class="{'font-medium text-gray-900': active == 'discount', 'text-gray-500': active != 'discount'}" class="block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0"> {{ translate('By Dicount') }} </a>
                <a href="#" @click="active = 'most_popular'" :class="{'font-medium text-gray-900': active == 'most_popular', 'text-gray-500': active != 'most_popular'}" class="block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0"> {{ translate('By Most Popular') }} </a>
                {{-- <a href="#" @click="active = 'best_rating'" :class="{'font-medium text-gray-900': active == 'best_rating', 'text-gray-500': active != 'best_rating'}" class="block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-1"> Best Rating </a> --}}
                <a href="#" @click="active = 'newest'" :class="{'font-medium text-gray-900': active == 'newest', 'text-gray-500': active != 'newest'}" class="block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-2"> {{ translate('By Newest') }} </a>
              </div>
            </div>
          </div>
        </div>
