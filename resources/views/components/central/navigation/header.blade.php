...
<nav class="bg-gray-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center space-between h-16">
            <div class="flex flex-1 items-center">
                <div class="flex-shrink-0">
                <a href="/">

                    <img class="h-8 w-8" src="https://tailwindui.com/img/logos/workflow-mark-indigo-300.svg"
                        alt="EV SaaS Logo">
                </a>
                </div>
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        {{-- <a href="#" class="bg-indigo-700 text-white px-3 py-2 rounded-md text-sm font-medium">
                            Dashboard
                        </a> --}}

                        <a href="/cost-of-running-a-website/"
                        ...
                        <a href="https://calendly.com/eim-solutions/new-project-inquries"
                        target="_blank"
                            class="text-white hover:bg-indigo-500 hover:bg-opacity-75 px-3 py-2 rounded-md text-sm font-medium">
                            Book A meeting
                        </a>
            ...
            <div>
            {{--  SEarch start 
            TODO: Add dynamic option to enable, disable search in header>
            --}}
            ...
            <div class="hidden md:block">
                ...
                @guest
                 <a href="{{ route('central.tenants.login') }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-primary bg-white hover:bg-primary-700">
                        Log in
                </a>

                 <a 
                 
                 href="https://demo.ev-saas.com" 
                 target="_blank"
