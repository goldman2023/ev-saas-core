                ...
                <div>
                    ...
                    <div class="mt-6">
                        <h2 class="text-3xl font-extrabold tracking-tight text-gray-900">
                            Offer great online experience for your clients
                        </h2>
                        <p class="mt-4 text-lg text-gray-500">
                            Subscription management protal, customer self service area e-commerce store or all of this
            ...
            <div class="mt-12 sm:mt-16 lg:mt-0">
                <div class="pl-4 -mr-48 sm:pl-6 md:-mr-16 lg:px-0 lg:m-0 lg:relative lg:h-full">
                    <img class="w-full rounded-xl shadow-xl ring-1 ring-black ring-opacity-5 lg:absolute lg:left-0 lg:h-full lg:w-auto lg:max-w-none"
                        src="{{ asset('central/ev-saas-dashboard.png') }}" alt="Inbox user interface">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="px-4 max-w-xl mx-auto sm:px-6 lg:py-32 lg:max-w-none lg:mx-0 lg:px-0 lg:col-start-2">
                <div>
                    ...
                    <div class="mt-6">
                        ...
                        <p class="mt-4 text-lg text-gray-500">
                            Our guided and user-friendly setup process will allow you to run your subscription, customer
                            portal, bookings or e-commerce project running in hours. A lot of solutions on the market,
                            makes developing online experiences expensive, slow and complicated process.
<br>
<br>
                           <strong> Save time money and energy by using EV-SaaS. </strong>
<br>
<br>
                            We've built websites and digital solutions for various clients for over 10 years and we
                            boiled down all best practices and features that are key to business growth and easy
                            management
                        </p>
                        <div class="mt-6">
