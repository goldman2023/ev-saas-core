<div class="bg-white">
    <div class="max-w-2xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <h2 class="text-2xl font-extrabold tracking-tight text-gray-900">{{ __('Customers also purchased') }}</h2>
            ...
            <a href="{{ route('products.index') }}" class="hidden text-sm font-semibold text-indigo-600 hover:text-indigo-500 sm:block">
            ...
            @foreach($products as $product)
                ...
                <div class="group relative">
                    <div
                        ...
                        <x-tenant.system.image alt="{{  $product->getTranslation('name') }}" class="w-full h-full object-center object-cover lg:w-full lg:h-full" :image="$product->thumbnail_img"></x-tenant.system.image>
