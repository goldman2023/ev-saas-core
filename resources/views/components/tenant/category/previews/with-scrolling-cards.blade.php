...
<div class="bg-white">
    <div class="py-16 sm:py-24 xl:max-w-7xl xl:mx-auto xl:px-8">
        <div class="px-4 sm:px-6 sm:flex sm:items-center sm:justify-between lg:px-8 xl:px-0">
            ...
            <a href="#" class="hidden text-sm font-semibold text-indigo-600 hover:text-indigo-500 sm:block">Browse all
        ...
        <div class="mt-6 px-4 sm:hidden">
            <a href="{{ route('categories.all') }}" class="block text-sm font-semibold text-indigo-600 hover:text-indigo-500">
