<div class="row align-items-sm-center py-sm-10">
    ...
    <div class="col-sm-6 col-md-4 text-center text-sm-left">
        <h2 class="h3 display-4 mb-2">{{ translate('No Companies Matched your Criteria') }}</h1>
            <p class="lead">
                {{ translate('We could not find companies according to requirements. You can recommend a company you know.') }}
            </p>
