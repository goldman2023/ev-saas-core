    ...
    <div class="text-center">
        ...
        <x-slot name="title_slot" we-title="Section Title">
            <x-ev.label
                ...
                :label="$dataOverides['title_slot']['components']['section_title']['title'] ?? ''">
            </x-ev.label>
        </x-slot>
        ...
        <x-slot name="text_slot" we-title="Section Text">
            <x-ev.label
                ...
                :label="$dataOverides['text_slot']['components']['section_text']['data']['title'] ?? ''">
            </x-ev.label>
        </x-slot>
        ...
        <div class="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
            ...
            <x-slot name="button_group_slot" we-title="Buttons">
                <x-ev.link-button-group
                    ...
                    :button_group="$dataOverides['button_group_slot']['components']['buttons']['data']['button_group'] ?? []">
                </x-ev.link-button-group>
            </x-slot>
        </div>
    </div>
