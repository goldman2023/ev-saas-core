        ...
        <div class="text-center">
            ...
            <div we-slot name="title_slot" we-title="Section Title" class="w-full">
                <x-ev.label
                    ...
                    we-title="Title"
                    class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl {{ $weData['title_slot']['components']['section_title']['data']['class'] ?? '' }}"
            ...
            <div we-slot name="text_slot" we-title="Section Text" class="w-full">
                <x-ev.label
                    ...
                    we-title="Text"
                    class="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl {{ $weData['text_slot']['components']['section_text']['data']['class'] ?? '' }}"
