        ...
        <div class="max-w-lg mx-auto lg:mx-0">
          ...
          <dl class="mt-12 space-y-10">
            <div class="relative">
              ...
              <dd class="mt-2 ml-16 text-base text-gray-500">Nunc a, lacinia sed risus neque, arcu, rhoncus. Id mauris justo facilisis aliquam platea vestibulum condimentum morbi.</dd>
            </div>
            ...
            <div class="relative">
              ...
              <dd class="mt-2 ml-16 text-base text-gray-500">Purus lobortis volutpat posuere id integer nunc tellus. Non mauris malesuada feugiat massa mi pellentesque cum est. Pharetra a varius urna rhoncus, tempor rutrum.</dd>
            </div>
            ...
            <div class="relative">
              ...
              <dd class="mt-2 ml-16 text-base text-gray-500">Tincidunt sollicitudin interdum nunc sit risus at bibendum vitae. Urna, quam ut sit justo non, consectetur et varius.</dd>
            </div>
          </dl>
        </div>
      </div>
