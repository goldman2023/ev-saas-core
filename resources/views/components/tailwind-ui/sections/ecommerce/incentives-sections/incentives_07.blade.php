...
<div class="bg-white">
    ...
    <div class="max-w-7xl mx-auto divide-y divide-gray-200 lg:py-6 lg:flex lg:justify-center lg:divide-y-0 lg:divide-x">
      <div class="py-6 lg:py-0 lg:w-1/3 lg:flex-none">
        <div class="max-w-xs mx-auto px-4 flex items-center lg:max-w-none lg:px-8">
          <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 h-8 w-8 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div class="py-8 lg:py-0 lg:w-1/3 lg:flex-none">
        <div class="max-w-xs mx-auto px-4 flex items-center lg:max-w-none lg:px-8">
          <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 h-8 w-8 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path vector-effect="non-scaling-stroke" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
          </svg>
          <div class="ml-4 flex-auto flex flex-col-reverse">
      ...
      <div class="py-8 lg:py-0 lg:w-1/3 lg:flex-none">
        <div class="max-w-xs mx-auto px-4 flex items-center lg:max-w-none lg:px-8">
          <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 h-8 w-8 text-indigo-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path vector-effect="non-scaling-stroke" d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 2 2 0 014 0z" />
