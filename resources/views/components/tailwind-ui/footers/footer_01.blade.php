    ...
    <div class="max-w-6xl mx-auto py-12 px-4 sm:px-5 lg:py-16 lg:px-8">
      <div class="lg:grid lg:grid-cols-5 lg:gap-8">
        ...
        <div class="col-span-1 lg:col-span-2 mt-8 xl:mt-0">
          <h3 class="text-sm font-semibold text-white tracking-wider uppercase">STAY UP TO DATE WITH PIX-PRO</h3>
          ...
          <form class="mt-4 sm:flex sm:max-w-md">
            ...
            <div class="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
              <button type="submit" class="w-full bg-[#8BC53F] border border-transparent rounded-md py-2 px-4 flex items-center justify-center text-base font-medium text-white hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-indigo-500">Subscribe</button>
            </div>
          </form>
        </div>
      </div>
      <div class="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
        ...
        <p class="mt-8 text-base text-gray-400 md:mt-0 md:order-1">&copy; 2022 {{ translate('PIX PRO') }}</p>
      </div>
    </div>
</footer>
