@php
$header_menu = nova_get_menu_by_slug('footer');
...
<footer class="bg-white">
    <div class="max-w-6xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        <div class="grid sm:grid-cols-3">
            <div>
                <p class="text-left text-base text-gray-400">&copy; {{ get_site_name() }} © 2022</p>
        ...
        <div class="hidden mt-8 flex justify-center space-x-6">
            ...
            <a href="{{ translate('twitter_url', true) }}" class="text-gray-400 hover:text-gray-500">
