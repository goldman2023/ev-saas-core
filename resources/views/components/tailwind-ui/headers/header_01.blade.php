    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-5">
      <div class="flex justify-between items-center py-6 md:justify-start md:space-x-10">
        <div class="flex justify-start lg:w-0 lg:flex-1">
          <a href="/">
            {{-- <x-tenant.system.image alt="{{ get_site_name() }} logo" class="block lg:hidden h-8 w-auto"
                :image="get_setting('header_logo')">
            </x-tenant.system.image> --}}
            <img class="h-8 w-auto sm:h-10" src="https://www.pix-pro.com/wp-content/uploads/2021/07/Logo.svg" alt="">
          </a>
        </div>
        ...
        <nav class="hidden md:flex space-x-[32px]">
          <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">{{ translate('Features') }}</a>
          <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">{{ translate('Pricing') }}</a>
          <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">{{ translate('Blog') }}</a>
          <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">{{ translate('Contact') }}</a>
          <a href="#" class="text-base font-medium text-gray-500 hover:text-gray-900">{{ translate('Support') }}</a>
        </nav>
    ...
    <div class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden" 
      ...
      <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
        <div class="pt-5 pb-6 px-5 border-b">
          <div class="flex items-center justify-between">
            <div>
                ...
                <img class="h-8 w-auto" src="https://www.pix-pro.com/wp-content/uploads/2021/07/Logo.svg" alt="">
            </div>
            <div class="-mr-2">
              <button type="button" class="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500"
        ...
        <div class="py-6 px-5 space-y-6">
            ...
            <div>
              <a href="#" @click="$dispatch('display-flyout-panel', {'id': 'auth-panel'})" class="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700">
                  {{ translate('Login') }}
              </a>
              <p class="mt-6 text-center text-base font-medium text-gray-500">
                {{ translate('Wanna try it out for free') }}?
                <a href="#" class="text-indigo-600 hover:text-indigo-500"> {{ translate('Get a Trial') }} </a>
              </p>
            </div>
        </div>
