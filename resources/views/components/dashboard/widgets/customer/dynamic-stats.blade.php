    ...
    <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
      <div class="relative bg-white pt-5 px-4 pb-12 sm:pt-6 sm:px-6 shadow rounded-lg overflow-hidden">
        <dt>
          ...
          <p class="ml-16 text-sm font-medium text-gray-500 truncate">Current Plan</p>
        </dt>
        <dd class="ml-16 pb-6 flex items-baseline sm:pb-7">
          <p class="text-2xl font-semibold text-gray-900">SOLO+ </p>
          ...
          <div class="absolute bottom-0 inset-x-0 bg-gray-50 px-4 py-4 sm:px-6">
            <div class="text-sm">
              <a href="{{ route('my.plans.management') }}" class="font-medium text-indigo-600 hover:text-indigo-500">
                Manage Subscription
                <span class="sr-only"> Total Subscribers stats</span></a>
            </div>
          </div>
        </dd>
      </div>
      ...
      <div class="relative bg-white pt-5 px-4 pb-12 sm:pt-6 sm:px-6 shadow rounded-lg overflow-hidden">
        <dt>
          ...
          <p class="ml-16 text-sm font-medium text-gray-500 truncate">Billing period</p>
        </dt>
        <dd class="ml-16 pb-6 flex items-baseline sm:pb-7">
          <p class="text-2xl font-semibold text-gray-900">yearly</p>
          <p class="ml-2 flex items-baseline text-sm font-semibold text-green-600">
            <!-- Heroicon name: solid/arrow-sm-up -->

            <span class="sr-only"> Increased by </span>
            Next invoice in 22 days
          </p>
          <div class="absolute bottom-0 inset-x-0 bg-gray-50 px-4 py-4 sm:px-6">
            <div class="text-sm">
      ...
      <div class="relative bg-white pt-5 px-4 pb-12 sm:pt-6 sm:px-6 shadow rounded-lg overflow-hidden">
        <dt>
          ...
          <p class="ml-16 text-sm font-medium text-gray-500 truncate">Cost</p>
        </dt>
        <dd class="ml-16 pb-6 flex items-baseline sm:pb-7">
          <p class="text-2xl font-semibold text-gray-900">100€ / year</p>
          ...
          <div class="absolute bottom-0 inset-x-0 bg-gray-50 px-4 py-4 sm:px-6">
            <div class="text-sm">
              <a href="#" class="font-medium text-indigo-600 hover:text-indigo-500">
                Modify plan
                <span class="sr-only"> Avg. Click Rate stats</span></a>
            </div>
          </div>
        </dd>
      </div>
