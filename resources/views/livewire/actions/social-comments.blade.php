<section class="bg-white dark:bg-gray-900 py-6 lg:py-6">
    <div class="max-w-2xl mx-auto px-4">
        <div class="hidden flex justify-between items-center mb-3">
        ...
        <article class="p-6 mb-6 text-base bg-gray-50 rounded-lg dark:bg-gray-700">
            <footer class="flex justify-between items-center mb-2">
                <div class="flex items-center">
                    <p class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white"><img
                            class="mr-2 w-6 h-6 rounded-full" src="{{ $comment->user->getThumbnail() }}"
                            alt="{{ $comment->user->full_name }}">
                        {{ $comment->user->full_name }}</p>
            ...
            <div class="flex items-center mt-4 space-x-4">
                ...
                <livewire:actions.social-action-button wire:key="comment_{{ $comment->id }}" :object="$comment" action="reaction" type="like">
