<section
    ...
    x-init="$watch('show', (value) => (!value) ? $('.cart-item').tooltip('dispose'): '')"
                        ...
                        >
                            <div class="row full-row">
                                ...
                                <div class="d-flex flex-column col-6 px-0 pr-3 mt-1">
                                    <strong class="fw-600 text-16 w-100 clamp d-inline-block mb-0" data-clamp-lines="1" style="line-height: 1.2;">{{ $item->getTranslation('name') }}</strong>

                                    @if($item->hasVariations())
                                        <span class="clamp text-12 mb-2" data-clamp-lines="1">{{ $item->getTranslation('excerpt') }}</span>
                                    @else
                                        {{-- TODO: Display variation attributes here in one row: (Inspiration -> https://cdn.dribbble.com/users/4817709/screenshots/16356375/media/86177cbea95d2df2983700a6e54bac2f.png) --}}s
                                    @endif

                                    <div class="bg-danger mr-auto square-18 rounded d-flex align-items-center justify-content-center pointer"
