        ...
        <div class="grid grid-cols-12 gap-8 mb-10">
            <div class="col-span-12 lg:col-span-3">
                <nav class="space-y-1 p-4 bg-white rounded-lg border border-gray-200">
                    ...
                    <a href="#" :class="{'text-primary': current === 'passwordSection', 'text-gray-500 hover:bg-gray-50 hover:text-gray-900': current !== 'passwordSection'}" 
                        class="flex items-center px-3 py-2 text-sm font-medium rounded-md"
                    ...
                    <a href="#" :class="{'text-primary': current === 'socialAccountsSection', 'text-gray-500 hover:bg-gray-50 hover:text-gray-900': current !== 'socialAccountsSection'}" 
                        class="flex items-center px-3 py-2 text-sm font-medium rounded-md"
            ...
            <div class="col-span-12 lg:col-span-9">
                ...
                <!-- Addresses -->
                <livewire:dashboard.forms.addresses.addresses-form component-id="addressesSection" :addresses="$this->me->addresses" type="address">
                </livewire:dashboard.forms.addresses.addresses-form>
                <!-- END Addresses -->

                <!-- Social accounts -->
                <div id="socialAccountsSection" class="p-4 border bg-white border-gray-200 rounded-lg shadow mt-5" x-data="{}">
                    <div class="w-full items-center border-b border-gray-200 pb-3">
                        <h3 class="text-lg leading-6 font-medium text-gray-900 mb-1">{{ translate('Social accounts') }}</h3>
                        <p class="flex items-center-1 max-w-2xl text-sm text-gray-500"> {{ translate('Connect social accounts to your current account') }}</p>
                    </div>
                            ...
                            @foreach(\App\Models\SocialAccount::$available_providers as $key => $provider)
                                ...
                                <li class="py-4 flex items-center justify-between">
                                    <div class="flex flex-col">
                                        ...
                                        <p class="text-sm text-gray-500">Nulla amet tempus sit accumsan. Aliquet turpis sed sit lacinia.</p>
                                    </div>

                                    <a class="btn-{{ ($social_account->connected ?? null) ? 'danger':'success' }}" href="{{ ($social_account->connected ?? null) ? '#' : route('social.connect', $key) }}" target="_blank">
