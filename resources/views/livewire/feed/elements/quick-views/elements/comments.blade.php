        ...
        <div class="bg-gray-50 px-4 py-6 sm:px-6">
            <div class="flex space-x-3">
                <div class="flex-shrink-0">
                    <img class="h-10 w-10 rounded-full" src="{{ auth()->user()->getThumbnail() }}" alt="">
                </div>
                    ...
                    <li>
                        <div class="flex space-x-3">
                            ...
                            <div>
                                ...
                                <div class="mt-1 text-sm text-gray-700">
                                    <p>Et ut autem. Voluptatem eum dolores sint
                            ...
                            <div>
                                ...
                                <div class="mt-1 text-sm text-gray-700">
                                    <p>Expedita consequatur sit ea voluptas quo ipsam
                                        ...
                                        voluptatem et eveniet. Nihil quas consequatur autem.
                                        Perferendis rerum et.</p>
                                </div>
                                <div class="mt-2 text-sm space-x-2">
                                    <span class="text-gray-500 font-medium">4d ago</span>
                                    <!-- space -->
