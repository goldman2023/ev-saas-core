@if(!empty($events))
<div class="w-full bg-white rounded-xl shadow pb-6">
...
<div class="text-center mb-6">
    ...
    <p class="mt-1 text-sm text-gray-500">
        {{ translate('There is no upcomming events. Submit new event!') }}
    </p>
    <div class="mt-6">
      <a type="button" class="inline-flex items-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
