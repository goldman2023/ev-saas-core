...
@section('meta')
    ...
    <meta property="og:url" content="{{ $detailedProduct->getPermalink() }}" />
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="py-3 px-0 list-group-item border-light">
                                    <div class="row gutters-10 align-items-center">
                                        <div class="col-5">
                                            <a href="{{ $top_product->getPermalink() }}" class="d-block text-reset">
                                                <img
                                        ...
                                        <div class="col-7 text-left">
                                            <h4 class="fs-13 text-truncate-2">
                                                <a href="{{ $top_product->getPermalink() }}" class="d-block text-reset">{{ $top_product->getTranslation('name') }}</a>
                                            </h4>
                            ...
                            <div class="aiz-carousel gutters-5 half-outside-arrow" data-items="5" data-xl-items="3" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true' data-infinite='true'>
                                ...
                                <div class="carousel-box">
                                    <div class="aiz-card-box border border-light rounded hov-shadow-md my-2 has-transition">
                                        <div class="">
                                            <a href="{{ $related_product->getPermalink() }}" class="d-block">
                                                <img
                                        ...
                                        <div class="p-md-3 p-2 text-left">
                                            ...
                                            <h3 class="fw-600 fs-13 text-truncate-2 lh-1-4 mb-0 h-35px">
                                                <a href="{{ $related_product->getPermalink() }}" class="d-block text-reset">{{ $related_product->getTranslation('name') }}</a>
                                            </h3>
            ...
            <div class="modal-content position-relative">
                ...
                <form class="" action="{{ route('conversations.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body gry-bg px-3 pt-3">
                        ...
                        <div class="form-group">
                            <textarea class="form-control" rows="8" name="message" required placeholder="{{ translate('Your Question') }}">{{ $detailedProduct->getPermalink() }}</textarea>
                        </div>
                    </div>
