...
<div class="we-dashboard-sidebar-background shadow-xl hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0 lg:border-r lg:border-gray-200 lg:pt-5 lg:pb-4 lg:bg-white">
    <div class="flex items-center flex-shrink-0 px-6">
        <a href="{{ route('dashboard') }} ">
            <x-tenant.system.image alt="{{ get_site_name() }} logo" class="min-h-8 w-auto max-h-24 mx-auto sm:min-h-10"
                :image="get_site_logo()">
