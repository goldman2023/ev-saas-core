                ...
                <tr>
                    <td>
                        <a href="{{ route('ev-products.details', $product->slug) }}">
                            <img class="avatar avatar-sm avatar-circle mr-3 border"
                                src="{{ $product->getThumbnail(['w' => 60]) }}" alt="{{ $product->name }}">
                        </a>
                    </td>
                    ...
                    <td>
                        ...
                        <a class="btn btn-soft-info btn-icon btn-circle btn-xs"
                            href="{{ route('ev-products.edit', $product->slug) }}">
                            @svg('heroicon-o-pencil-alt', ['style' => 'height: 16px;'])
                        </a>
                        <a class="btn btn-soft-danger btn-icon btn-circle btn-xs confirm-delete"
