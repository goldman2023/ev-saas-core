        ...
        <div class="border-t border-gray-200">
            ...
            <div class="grid grid-cols-3">
                ...
                <div
                    ...
                    <a href="{{ $order->invoices->first()?->meta['test_stripe_hosted_invoice_url'] ?? '#' }}"
                        target="_blank" class="btn-primary min-w-[130px] justify-center">
                ...
                <dl class="space-y-6 border-t border-gray-200 text-sm pt-6 col-start-1 md:col-start-2 col-end-4">
                    ...
                    <div class="w-full flex flex-col">
                        ...
                        <div class="w-full flex justify-between mb-1">
                            <span class="text-14 text-gray-600 font-normal">
                                {{ $order_item->quantity.' '.translate('user') }} x {{
                                \FX::formatPrice($order_item->total_price / $order_item->quantity) }} / {{
                                translate('user') }} / {{ $order->invoicing_period }}
                            </span>

                            <span class="text-14 text-gray-600 font-normal">{{ \FX::formatPrice($order_item->total_price
                                * $order_item->quantity) }} / {{ $order->invoicing_period }}</span>
                        </div>
                    ...
                    <div class="w-full flex flex-col mt-3 pt-3 border-t border-gray-200">
                        ...
                        <div class="w-full flex justify-between items-center mt-3 pt-3 border-t border-gray-200">
                            ...
                            <span class="text-14 text-gray-600 font-normal">
                                {{ translate('Total') }}: <strong>{{ \FX::formatPrice($tax_sum + $items_sum) }} / {{
