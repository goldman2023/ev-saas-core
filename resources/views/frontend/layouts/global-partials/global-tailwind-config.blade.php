    ...
    @layer utilities {
        ...
        *::-webkit-scrollbar { width: 0 !important }
        ...
        .btn-standard-outline {
            @apply cursor-pointer inline-flex items-center px-4 py-2 border border-gray-400 rounded-md shadow-sm text-sm font-medium text-gray-500 bg-white hover:bg-gray-400 hover:text-white;
        }
