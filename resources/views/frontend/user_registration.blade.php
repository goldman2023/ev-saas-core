            ...
            <div class="mt-8">
                <div>
                    ...
                    <div class="mt-6 relative">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span class="px-2 bg-white text-gray-500"> {{ translate('Fill out your profile details')  }} </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6">
                    <form id="reg-form" class="space-y-6" role="form" action="{{ route('register') }}" method="POST">
                        ...
                        <div>
                            <button type="submit"
                                class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-700 hover:bg-success focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                {{ translate('Register') }}
                            </button>
                        </div>
                    </form>
