        ...
        <div class="mx-auto w-full max-w-sm lg:w-96">
            <div>
                ...
                <p class=" mt-2 text-sm text-gray-600">
                    {{ translate('Or') }}
                    <a href="{{ route('user.login') }}" class="font-medium text-indigo-600 hover:text-indigo-500"> {{ translate('Already a member? Sign In') }} </a>
                </p>
            </div>
            ...
            <div class="mt-3">
                ...
                <div class="mt-">
                    <form id="reg-form" class="space-y-6" role="form" action="{{ route('register') }}" method="POST">
                        @csrf
                        <div>
                        ...
                        <div>
                            <label for="email" class="block text-sm font-medium text-gray-700"> {{ translate('Email address') }} </label>
                            <div class="mt-1">
                                <input id="email" name="email" type="email" autocomplete="email" required class="form-standard">
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="mt-1">
                                <input id="password" name="password" type="password" autocomplete="current-password" required class="form-standard">
                        ...
                        <div class="space-y-1">
                            ...
                            <div class="mt-1">
                                <input id="password_confirmation" name="password_confirmation" type="password" autocomplete="current-password" required class="form-standard">
                                <x-system.invalid-msg class="w-full" field="password_confirmation"></x-system.invalid-msg>
                            </div>
                        </div>

                        <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <input id="remember-me" name="remember-me" type="checkbox" class="form-checkbox-standard">
                                <label for="remember-me" class="ml-2 block text-sm text-gray-900"> {{ translate('Remember me') }} </label>
                            </div>
                        ...
                        <div>
                            <button type="submit"
                                class="btn-primary w-full justify-center items-center">
                                {{ translate('Register') }}
                            </button>
                        </div>
                    </form>
