                ...
                <ul class="nav nav-tabs nav-fill border-light">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-reset @if ($language->code == $lang) active @else bg-soft-dark border-light border-left-0 @endif py-3"
                            href="{{ route('seller.product.edit', ['id'=>$product->id, 'lang'=> $language->code] ) }}">
                ...
                <div class="col-lg-8">
                    <select class="form-control aiz-selectpicker" data-live-search="true"
                        ...
                        <option value="{{ $color->code }}"
                            ...
                            <?php if(in_array($color->code, $product->colors)) echo 'selected'?>></option>
                        @endforeach
                    </select>
                </div>
                <div class="col-lg-1">
                    <label class="aiz-switch aiz-switch-success mb-0">
                        <input value="1" type="checkbox" name="colors_active"
                            <?php if(count($product->colors) > 0) echo "checked";?>>
                        <span></span>
                    </label>
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                    <select name="choice_attributes[]" data-live-search="true" data-selected-text-format="count"
                        ...
                        <option value="{{ $attribute->id }}" @if(in_array($attribute->id, $product->attributes))
                            selected @endif>
