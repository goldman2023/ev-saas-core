            ...
            <table class="table aiz-table mb-0">
                ...
                <tbody>
                    @foreach ($products as $key => $product)
                        <tr>
                            <td>{{ $key+1 }}</td>
                            <td><a href="{{ $product->getPermalink() }}" target="_blank">{{   $product->getTranslation('name')  }}</a></td>
                            <td>
                                <a href="{{ $product->getPermalink() }}" target="_blank" class="text-reset">
                            ...
                            <td class="text-right">
                                <a href="{{route('seller.digitalproduct.edit',  ['id'=>$product->id, 'lang'=>config('app.locale')] )}}" class="btn btn-soft-info btn-icon btn-circle btn-sm" title="{{ translate('Edit') }}">
