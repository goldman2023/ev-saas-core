        ...
        <div class="container">
            <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                <div class="d-flex mb-3 align-items-baseline border-bottom">
                    ...
                    <a href="{{ route('category.products.index', $category->slug) }}" class="ml-auto mr-0 btn btn-primary btn-sm shadow-md">{{ translate('View More') }}</a>
                </div>
                                ...
                                <div class="p-md-3 p-2 text-left">
                                    <div class="fs-15">
                                        @if($product->getBasePrice() != $product->getTotalPrice(true))
                                            <del class="fw-600 opacity-50 mr-1">{{ $product->getBasePrice() }}</del>
                                        @endif
