    ...
    <div class="grid grid-cols-3 space-2 gap-10">
                ...
                <div class="max-w-3xl mx-auto">
                    <div class="max-w-xl">
                        <h1 class="text-sm font-semibold uppercase tracking-wide text-indigo-600">
                            {{ translate('Transparency & Custome protection') }}</h1>
                        <p class="mt-2 text-4xl font-extrabold tracking-tight sm:text-5xl">

                            {{ translate('Get verified') }} {{ get_site_name() }}
                            <span class="emoji ml-2">✅</span>
                        </p>
                        <p class="mt-6 text-base text-gray-500">{{ translate('FoxAsk community values transparency and
                            authenticity of content and products added to he marketplace.') }}</p>
                    ...
                    <div class="grid grid-cols-2 gap-10">
                        <div class="">
                            <dl class="mt-12 mb-6 text-sm font-medium  ">
                                ...
                                <p class="x">
                                    {{ translate('This is how your profile will be shown after verification') }}

                                </p>
                            </dl>
                            <div class="border-t border-gray-200">
                                <x-default.elements.user-card :user="auth()->user()" verified="true">
                                </x-default.elements.user-card>
                            </div>
                        ...
                        <div class="">
                            ...
                            <div class="max-w-lg mx-auto mt-12">
                                <h2 class="text-lg font-medium text-gray-900">
                                    {{ get_site_name() }} {{ translate('Verification Process ') }}
                                </h2>
        ...
        <div class="col-span-1">
            <div>
                <a
                target="_blank"
                class="text-xs btn-primary p-8 block  w-full py-[20px] btn font-bold" href="https://buy.stripe.com/4gwbINfaF1wd4o09AB">
                  {{ translate('Pay securely 1€') }}
                </a>
                <small class="text-xs mb-6 text-center block mt-3">{{ translate('100% secure payments via stripe') }} </small>
            ...
            <div class="mb-6 relative">
                ...
                <div class="relative flex justify-center text-sm">
                    <span class="px-2 bg-white text-gray-500"> {{ translate('Have questions? Need help?') }} </span>
                </div>
            </div>
