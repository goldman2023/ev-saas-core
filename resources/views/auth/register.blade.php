...
<section class="bg-white dark:bg-gray-900">
    <div class="grid  lg:grid-cols-2">
        <div class="!pb-12 flex justify-center items-center py-6 px-4 lg:py-0 sm:px-0">
            ...
            <form class="hidden space-y-4 max-w-md md:space-y-6 xl:max-w-xl" action="#">
                ...
                <div class="items-center space-y-3 space-x-0 sm:flex sm:space-x-4 sm:space-y-0">
                    ...
                    <a href="#"
                        class="w-full inline-flex items-center justify-center py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-gray-900 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                        <svg class="mr-2 w-5 h-5 text-gray-900 dark:text-white" viewBox="0 0 21 20" fill="none"
                ...
                <div>
                    <label for="full-name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">What
                        should we call you?</label>
                    <input type="text" name="full-name" id="email"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                        placeholder="e.g. Bonnie Green" required="">
                </div>
                <div>
                ...
                <div class="space-y-3">
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="terms" class="font-light text-gray-500 dark:text-gray-300">By signing up, you
                                are creating a Flowbite account, and you agree to Flowbite’s <a
                    ...
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="newsletter" class="font-light text-gray-500 dark:text-gray-300">Email me about
                                product updates and resources.</label>
                        </div>
                    </div>
                </div>
                <button type="submit"
                    class="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-700">Create
                    an account</button>
        ...
        <div class="pb-12 flex justify-center items-top py-6 px-4 bg-primary-600 lg:py-0 sm:px-0">
            <div class="max-w-md xl:max-w-xl pt-8">
                ...
                <p class="mb-4 font-light text-primary-200 lg:mb-8">
                    {{ translate('Manage and track your orders, download invoices and customer support is waiting you
                    inside') }}
                </p>
                <div class="flex items-center divide-x divide-primary-500">
                    ...
                    <a href="#" class="pl-3 text-white sm:pl-5 dark:text-white">
                        <span class="text-sm text-primary-200">
                            {{ translate('Have questions? Support is online') }}
                            <span
                                class="bg-green-100 text-green-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800">
