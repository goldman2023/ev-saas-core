...
<body>
    ...
    <table class="table">
        <thead>
            <tr>
                <th class="border-0 pl-0" style="font-size: 18px; " width="48.5%">
                    {{ __('invoices::invoice.seller') }}
                </th>
                <th class="border-0" width="3%"></th>
                <th class="border-0 pl-0" style="font-size: 18px; ">
    ...
    @if($invoice->status)
    <h4 class="text-uppercase cool-gray" style="font-size: 18px;">
